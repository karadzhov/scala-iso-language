...
lazy val root = project
  .in(file("."))
  .aggregate(
    `scala-iso-language-core`.js, `scala-iso-language-core`.jvm, `scala-iso-language-core`.native,
    `scala-iso-language-i18n-core`.js, `scala-iso-language-i18n-core`.jvm, `scala-iso-language-i18n-core`.native,
    `scala-iso-language-i18n-ar`.js, `scala-iso-language-i18n-ar`.jvm, `scala-iso-language-i18n-ar`.native,
    `scala-iso-language-i18n-bg`.js, `scala-iso-language-i18n-bg`.jvm, `scala-iso-language-i18n-bg`.native,
    `scala-iso-language-i18n-cs`.js, `scala-iso-language-i18n-cs`.jvm, `scala-iso-language-i18n-cs`.native,
    `scala-iso-language-i18n-de`.js, `scala-iso-language-i18n-de`.jvm, `scala-iso-language-i18n-de`.native,
    `scala-iso-language-i18n-en`.js, `scala-iso-language-i18n-en`.jvm, `scala-iso-language-i18n-en`.native,
    `scala-iso-language-i18n-es`.js, `scala-iso-language-i18n-es`.jvm, `scala-iso-language-i18n-es`.native,
    `scala-iso-language-i18n-fr`.js, `scala-iso-language-i18n-fr`.jvm, `scala-iso-language-i18n-fr`.native,
    `scala-iso-language-i18n-hi`.js, `scala-iso-language-i18n-hi`.jvm, `scala-iso-language-i18n-hi`.native,
    `scala-iso-language-i18n-it`.js, `scala-iso-language-i18n-it`.jvm, `scala-iso-language-i18n-it`.native,
    `scala-iso-language-i18n-pl`.js, `scala-iso-language-i18n-pl`.jvm, `scala-iso-language-i18n-pl`.native,
    `scala-iso-language-i18n-pt`.js, `scala-iso-language-i18n-pt`.jvm, `scala-iso-language-i18n-pt`.native,
    `scala-iso-language-i18n-ru`.js, `scala-iso-language-i18n-ru`.jvm, `scala-iso-language-i18n-ru`.native,
    `scala-iso-language-i18n-zh`.js, `scala-iso-language-i18n-zh`.jvm, `scala-iso-language-i18n-zh`.native
  )
  .settings(
